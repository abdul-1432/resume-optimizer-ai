  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', padding: 20 }}>
        <div className="card" style={{ width: '100%', maxWidth: 440, position: 'relative', overflow: 'hidden' }}>
          <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(circle at 20% -10%, rgba(96,165,250,0.18), transparent 40%), radial-gradient(circle at 120% 50%, rgba(167,139,250,0.18), transparent 40%)', pointerEvents: 'none' }} />
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, marginBottom: 10 }}>
            <div className="badge">A</div>
            <div style={{ fontWeight: 700, letterSpacing: 0.4 }}>Welcome back</div>
          </div>
